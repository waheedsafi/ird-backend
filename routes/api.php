...
require __DIR__ . '/v1/template/priority.php';
require __DIR__ . '/v1/app/news/news.php';
require __DIR__ . '/v1/app/news/newsType.php';
require __DIR__ . '/v1/app/donor/donor.php';
require __DIR__ . '/v1/auth/organizationAuth.php';
require __DIR__ . '/v1/app/representor/representor.php';
require __DIR__ . '/v1/app/agreement/agreement.php';
require __DIR__ . '/v1/app/director/director.php';
require __DIR__ . '/v1/app/pending/pendingTask.php';
require __DIR__ . '/v1/app/file/file.php';
require __DIR__ . '/v1/app/organization/organization.php';
require __DIR__ . '/v1/app/organization/organizationType.php';
require __DIR__ . '/v1/app/organization/registerationForm.php';
