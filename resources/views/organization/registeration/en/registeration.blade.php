    ...
    <body>
        ...
        <div class="min-contents">
            ...
            <p class="content-text">
                This registration is signed on ({{ $date_of_sign }}) which represents a registration of (
                {{ $register_number }} ) with the Ministry of Public Health.This document is not NOC or MoU. All NGOs
                must obtain NICs or permission from MoPH prior to the implementation of the health project.
            </p>
            <p class="content-text">
            ...
            <p class="content-text">
                ...
                must obtain permission/NOC from the MoPH and sign MoU with the MoPH before the implementation of their
                health project.
                <br>
                ...
                and competency.
                <br>
                14-Agency will contribute towards training relevant Afghan staff based on a training need assessment for
                ...
                <br>
                19-Any disputes will be resolved through discussion with Provincial Health Coordination Committee (PHCC)
                or central MoPH representatives. MoPH reserves the right to appoint a third party to
