...
class OrganizationInitStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // director
            "director_name_english" => "required|max:32|min:3",
            "director_name_farsi"  => "required|max:32|min:3",
            "director_name_pashto" => "required|max:32|min:3",
            "surname_english" => "required|max:32|min:3",
            "surname_pashto" => "required|max:32|min:3",
            "surname_farsi" => "required|max:32|min:3",
