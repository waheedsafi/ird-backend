...
interface PendingTaskRepositoryInterface
{
     ...
     * $task_type: Name of the task e.g. organization_registeration
     * $task_type_id: Id of the particular table e.g. In organization_registeration id must be organization id
